...
It is possible to simulate any 2D geometry with an arbitrary initial guess. Both single component system, i.e conventional superconductors, and unconventional multicomponent system can be simulated. This includes anisotropic materials and system featuring condensates with different charges. 
